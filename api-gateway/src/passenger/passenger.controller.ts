import {
  ...
  export class PassengerController {
    ...
    create(@Body() passengerDto: PassengerDTO): Observable<PassengerInterface> {
      return this.clientProxyPassenger.send(PassengerMessage.Create, passengerDto);
    }
    ...
    update(
      ...
      return this.clientProxyPassenger.send(PassengerMessage.Update, { id, passengerDto });
    }
